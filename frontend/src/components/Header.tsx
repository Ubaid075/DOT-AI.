...
import { SunIcon, MoonIcon, SparklesIcon, LogoutIcon, UserIcon, StarIcon, UndoIcon, RedoIcon } from './Icons';
...
const Header: React.FC = () => {
  ...
  const { currentUser, logout, undo, redo, canUndo, canRedo } = useAuth();
          ...
          <div className="flex justify-between items-center h-20 border-b border-gray-200 dark:border-gray-800">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              {currentUser ? (
               ...
               <div className="hidden sm:flex items-center gap-1 pl-2 border-l border-gray-200 dark:border-gray-700">
                <Button
                    onClick={undo}
                    disabled={!canUndo}
                    variant="secondary"
