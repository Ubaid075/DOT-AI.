...
import { DownloadIcon, ImageIcon, WandIcon, MinusIcon, PlusIcon, ResetIcon, HeartIcon } from './Icons';
    ...
    <div className="container mx-auto max-w-5xl py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-1 space-y-6 p-6 bg-white dark:bg-gray-800/50 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <ControlSelect<AspectRatio> label="Aspect Ratio" value={aspectRatio} onChange={setAspectRatio} options={Object.values(AspectRatio)} />
        ...
        <div className="lg:col-span-2 p-6 bg-white dark:bg-gray-800/50 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 flex items-center justify-center aspect-square">
          {isLoading ? (
